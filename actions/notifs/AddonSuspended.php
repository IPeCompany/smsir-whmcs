...
function smsir_vo_AddonSuspended($params){
    $hookname = 'AddonSuspended';
    $id = $params['id'];
    $uid = $params['uid'];
...
function smsir_vo_AddonSuspended_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'مسدودسازی افزودنی',
