...
function smsir_vo_AfterModuleChangePackage($params){
    $hookname = 'AfterModuleChangePackage';
...
function smsir_vo_AfterModuleChangePackage_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'بعد از تغییر پکیج',
            ...
            'type_send' => 'default',
            'send_for' => 'all',
            'message' => "{firstname} عزیز \nتغییر پکیج شما با موفقیت انجام شد \n{signature}",
