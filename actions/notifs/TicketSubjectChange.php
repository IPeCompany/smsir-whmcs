...
function smsir_vo_TicketSubjectChange($params){
    $hookname = 'TicketSubjectChange';
...
function smsir_vo_TicketSubjectChange_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'تغییر موضوع تیکت',
            ...
            'type_send' => 'default',
            'send_for' => 'all',
            'message' => "{firstname} عزیز \nتیکت {tid} به {subject} تغییر موضوع یافت \n{signature}",
