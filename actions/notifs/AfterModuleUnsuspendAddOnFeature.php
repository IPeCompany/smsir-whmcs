...
function smsir_vo_AfterModuleUnsuspendAddOnFeature($params){
    $hookname = 'AfterModuleUnsuspendAddOnFeature';
...
function smsir_vo_AfterModuleUnsuspendAddOnFeature_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'پس از بازگشایی افزودنی سرویس',
            ...
            'type_send' => 'default',
            'send_for' => 'all',
            'message' => "{firstname} عزیز \nافزودنی سرویس {domain} مجدد فعال شد \n{signature}",
