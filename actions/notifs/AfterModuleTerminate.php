...
function smsir_vo_AfterModuleTerminate($params){
    $hookname = 'AfterModuleTerminate';
...
function smsir_vo_AfterModuleTerminate_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'بعد از حذف سرویس',
