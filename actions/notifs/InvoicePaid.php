...
function smsir_vo_InvoicePaid($params){
    $hookname = 'InvoicePaid';
...
function smsir_vo_InvoicePaid_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'فاکتور پرداخت شد',
            ...
            'type_send' => 'default',
            'send_for' => 'all',
            'message' => "{firstname} عزیز \nفاکتور شماره {inv_id} باموفقیت پرداخت شد \n{signature}",
