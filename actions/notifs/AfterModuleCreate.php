...
function smsir_vo_AfterModuleCreate($params){
    $hookname = 'AfterModuleCreate';
...
function smsir_vo_AfterModuleCreate_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'بعد از ایجاد سرویس',
            ...
            'type_send' => 'default',
            'send_for' => 'all',
            'message' => "{firstname} عزیز \nسرویس {domain} با موفقیت ایجاد شد \n{signature}",
