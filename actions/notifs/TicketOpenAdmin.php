...
function smsir_vo_TicketOpenAdmin($params){
    $hookname = 'TicketOpenAdmin';
...
function smsir_vo_TicketOpenAdmin_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'بازکردن تیکت توسط مدیر',
            ...
            'type_send' => 'default',
            'send_for' => 'all',
            'message' => "{firstname} عزیز \nدپارتمان {deptname} برای شما تیکتی با موضوع {subject} ایجاد کرده است \n{signature}",
