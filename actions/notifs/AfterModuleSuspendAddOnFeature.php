...
function smsir_vo_AfterModuleSuspendAddOnFeature($params){
    $hookname = 'AfterModuleSuspendAddOnFeature';
...
function smsir_vo_AfterModuleSuspendAddOnFeature_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'بعد از مسدودسازی افزودنی سرویس',
