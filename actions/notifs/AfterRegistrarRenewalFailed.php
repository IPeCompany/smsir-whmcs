...
function smsir_vo_AfterRegistrarRenewalFailed($params){
    $hookname = 'AfterRegistrarRenewalFailed';
...
function smsir_vo_AfterRegistrarRenewalFailed_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'خطا در تمدید دامنه',
