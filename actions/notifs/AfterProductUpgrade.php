...
function smsir_vo_AfterProductUpgrade($params){
    $hookname = 'AfterProductUpgrade';
...
function smsir_vo_AfterProductUpgrade_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'پس از ارتقا سرویس',
