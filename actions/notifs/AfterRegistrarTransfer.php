...
function smsir_vo_AfterRegistrarTransfer($params){
    $hookname = 'AfterRegistrarTransfer';
...
function smsir_vo_AfterRegistrarTransfer_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'پس از انتقال دامنه',
            ...
            'type_send' => 'default',
            'send_for' => 'all',
            'message' => "{firstname} عزیز \nدامنه {sld}.{tld} با موفقیت منتقل شد \n{signature}",
