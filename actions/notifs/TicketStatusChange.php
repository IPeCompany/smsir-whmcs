...
function smsir_vo_TicketStatusChange($params){
    $hookname = 'TicketStatusChange';
...
function smsir_vo_TicketStatusChange_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            ...
            'type_send' => 'default',
            'send_for' => 'all',
            'message' => "{firstname} عزیز \nتیکت {subject} به {status} تغییر یافت \n{signature}",
