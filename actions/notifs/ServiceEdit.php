...
function smsir_vo_ServiceEdit($params){
    $hookname = 'ServiceEdit';
...
function smsir_vo_ServiceEdit_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'ویرایش سرویس کاربر',
