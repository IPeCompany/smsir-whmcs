...
function smsir_vo_AfterRegistrarRenewal($params){
    $hookname = 'AfterRegistrarRenewal';
...
function smsir_vo_AfterRegistrarRenewal_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'پس از تمدید دامنه',
            ...
            'type_send' => 'default',
            'send_for' => 'all',
            'message' => "{firstname} عزیز \nدامنه {sld}.{tld} با موفقیت تمدید شد \n{signature}",
