...
function smsir_vo_AddonActivation($params){
    $hookname = 'AddonActivation';
    $id = $params['id'];
    $uid = $params['uid'];
...
function smsir_vo_AddonActivation_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'زمانی که افزودنی خودکار فعال شد',
