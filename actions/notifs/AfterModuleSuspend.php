...
function smsir_vo_AfterModuleSuspend($params){
    $hookname = 'AfterModuleSuspend';
...
function smsir_vo_AfterModuleSuspend_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'بعد از ساسپند سرویس',
