...
function smsir_vo_AfterRegistrarRegistration($params){
    $hookname = 'AfterRegistrarRegistration';
...
function smsir_vo_AfterRegistrarRegistration_install($hookname){
    try{
        Capsule::table('smsir_vo_hooks')->insert([
            'name' => $hookname,
            'label' => 'پس از ثبت دامنه',
            ...
            'type_send' => 'default',
            'send_for' => 'all',
            'message' => "{firstname} عزیز \nدامنه {sld}.{tld} با موفقیت ثبت شد \n{signature}",
