...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    vahab::Alert([
        ...
        'url' => 'addonmodules.php?module=smsir&action=usersend'
    ]);
}
...
<div class="row">
    ...
    <?php
        ...
        foreach ($hookdata as $item){
            ...
            $slct_default = vahab::selectmenu('default', [$item->type_send]);
            $slct_pattern = vahab::selectmenu('pattern', [$item->type_send]);

            $status = $item->user_status;
            $type_send = $item->type_send;
